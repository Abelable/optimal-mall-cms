...
import { useDeleteTodayGoods } from "service/todayGoods";
...
export const List = ({
  ...
  const { mutate: deleteTodayGoods } = useDeleteTodayGoods(
    useTodayGoodsListQueryKey()
  );
